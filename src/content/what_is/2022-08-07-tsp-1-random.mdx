...
<Figure src="/assets/images/what-is/tsp-1/objective-function.png" alt="Graph of an objective function." caption="The above objective function shows how different solutions might compare. Depending on what we were interested in, we would either want find a maximum, or a minimum. Although with these types of problems it is often impossible to prove that you have done so." />
