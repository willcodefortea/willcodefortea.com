...
<Figure src="/assets/images/what-is/chain-of-responsibility/chain-of-responsibility.jpg" alt="Flow chart of a chain of responsibility." caption="Each handler in the chain can decide to handle the request, or pass it to the next handler in the chain." />
