...
<Figure src="/assets/images/what-is/wal/purchase-fanout.jpeg" alt="Sequence diagram of a user purchase, notifying the warehouse and finance team in parallel." caption="When Alice buys an item, the checkout service should let the warehouse and finance team know about it in parallel." />
...
<Figure src="/assets/images/what-is/wal/purchase-fanout-with-wal.jpeg" alt="Sequence diagram of a user purchase, notifying the warehouse and finance team in parallel." caption="When Alice buys an item, the checkout service should let the warehouse and finance team know about it in parallel." />
