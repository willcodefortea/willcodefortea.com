...
<Figure src="/assets/images/what-is/tsp-3/2-opt.png" alt="Diagram of the impact of a 2-opt movement." caption="2-opt undoing a section of a path that cross over itself, reducing the overall distance travelled." />
...
<Figure src="/assets/images/what-is/tsp-3/local-hill-climb.png" alt="Chart of solution space demonstrating the impact of climbing a locally bad hill." caption="We can see that despite there being many other solutions nearby, we can never reach them as we're only allowed to go up, not down." />
...
<Figure src="/assets/images/what-is/tsp-3/diversification.png" alt="Chart of solution space demonstrating the impact of diversification." caption="Despite a diversification step producing a much worse result, twe see that it goes on to produce an overall better solution." />
